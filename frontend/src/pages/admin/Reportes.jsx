...
import { getDashboard, getReportePorEspecialidad, exportarExcel } from '../../lib/api';
...
export default function Reportes() {
  ...
  const handleExportExcel = async () => {
    setExportando(true);
    try {
      const params = Object.fromEntries(Object.entries(fechas).filter(([_, v]) => v));
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3 items-end">
        ...
        <button
          ...
          disabled={exportando}
          className="flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-white bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors"
        >
